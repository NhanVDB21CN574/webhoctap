        ...
        <main class="main-content">
            ...
            <c:forEach items="${b}" var="o">
                ...
                <div style="font-size: 20px;">
                        A:<input class="thea inthe"  type="text" name="A0" value="${o.a}">
                        B:<input class="theb inthe" class="inques"type="text" name="B0" value="${o.b}"><br>
                        C:<input class="thec inthe" class="inques"type="text"name="C0" value="${o.c}">
                        D:<input class="thed inthe"  class="inques"  type="text"name="D0" value="${o.d}"><br>
                        Answer:<input style="margin-right: 80px;" class="thecheck inthe" "type="text"name="answer0" value="${o.answer}">
                    </div>
